...
class SyncfusionFlutterChartsAdvancedRealtimeStreamChartWidget extends StatelessWidget {
  const SyncfusionFlutterChartsAdvancedRealtimeStreamChartWidget({super.key});
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        return SfCartesianChart(
          title: ChartTitle(text: 'Tráfico Tiempo Real (Spline)'),
